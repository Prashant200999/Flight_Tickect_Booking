...
if(!empty($_POST)) {
    $submittedData = $_POST;
    $status = createUserRecord($submittedData);
    if($status == true) {
        header("index.php?status=1");
    } else {
        header("index.php?status=0");
    }
}
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form method="post">
                            ...
                            <div class="form-outline mb-4 mt-4">
                                ...
                                <!-- dob -->
                            <div class="form-outline mb-4 mt-4">
                                <input type="date" name="dob" id="" class="form-control form-control-lg">
                            </div>
                            <!-- Password input -->
                            <div class="form-outline mb-3">
                                <input type="password" id="form3Example4" name="upassword" class="form-control form-control-lg"
                                    placeholder="Enter new password" />

                            </div>
                            <div class="form-outline mb-3">
                                <input type="password" id="form3Example4" class="form-control form-control-lg mb-4 mt-4"
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                    ...
                                    <button type="submit"   class="btn btn-primary btn-lg mb-4" >Register</button>
                                    <a href="index.php" class="btn btn-primary btn-lg mb-4">Login</a>

                                    <button type="button" class="btn btn-outline-danger btn-lg mb-4"
